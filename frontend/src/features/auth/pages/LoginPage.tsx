...
export default function LoginPage({
  ...
  return (
    <AuthShell
      title="Welcome back"
      subtitle="Sign in to your enterprise console"
      footer={
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between py-1">
          <div className="flex items-center gap-2.5">
            ...
            <Label htmlFor="remember" className="text-muted text-xs cursor-pointer uppercase font-bold tracking-wider">
              Remember me
            </Label>
          </div>
          <button
            ...
            className="text-xs text-white hover:text-lime transition-colors underline-offset-4 hover:underline uppercase font-bold tracking-wider"
          >
            Forgot password?
          </button>
        </div>
